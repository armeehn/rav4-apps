 ...
 *
 * URI form: content://com.ripostelabs.files.fileprovider/raw/<Uri.encode(abs path)>
 * Read-only, exported=false, grantUriPermissions=true so per-intent grants work.
 */
public class FileProvider extends ContentProvider {

    public static final String AUTHORITY = "com.ripostelabs.files.fileprovider";
