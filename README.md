...
<!-- The number is checked by scope/check-theme-wiring.sh against apps/com.ripostelabs.* -->
28 clean-room replacements for the built-in apps on a Choiceway / AiNavi
